...
class $AssetEnvGen {
  ...
  /// File path: asset/env/.dev.env
  String get dev => 'asset/env/.dev.env';

  /// File path: asset/env/.prod.env
  String get prod => 'asset/env/.prod.env';
...
class Assets {
  ...
  static const $AssetEnvGen env = $AssetEnvGen();
